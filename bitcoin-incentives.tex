...
Bitcoin is a novel p2p phenomenon which includes a decentralized
consensus-derived history of transactions. The way to confirm the absence of a
prior transaction is to have the entire history of prior transactions. However,
the presence of physical reality imposes various constraints on system design
and operation. There are many histories being generated simultaneously
everywhere in the universe with the usual passage of time. The synchronization
of these histories cannot happen faster than the communication latency of a
system, nor faster than the speed of light anyway. For these reasons and
others, possessing all recent transaction history "in real time" is problematic
or impossible. Bitcoin provides some rules and incentives for maintaining a
consensus history under these physical constraints. A complete mechanical or
physical understanding of Bitcoin has yet to be introduced and is not offered
here. This document focuses on an enumeration of incentives and constraints
involved in Bitcoin.
